...
module.exports = class OrganizationsDBApi {
  ...
  static async bulkImport(data, options) {
    ...
    const organizationsData = data.map((item) => ({
  ...
  static async update(id, data, options) {
    ...
    const organizations = await db.organizations.findByPk(id, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.team_members_organization =
      await organizations.getTeam_members_organization({
        transaction,
      });
