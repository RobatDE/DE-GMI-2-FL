...
module.exports = class TeamsDBApi {
  static async create(data, options) {
    ...
    await teams.setProject(data.project || null, {
      transaction,
    });

    await teams.setOrganization(data.organization || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.projects_team = await teams.getProjects_team({
      transaction,
    });
    ...
    output.project = await teams.getProject({
      transaction,
    });
