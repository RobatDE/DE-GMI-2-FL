...
module.exports = class Team_membersService {
  static async create(data, currentUser) {
    ...
    try {
      await Team_membersDBApi.create(data, {
        currentUser,
        transaction,
      });
  ...
  static async update(data, id, currentUser) {
    ...
    try {
      ...
      if (!team_members) {
        throw new ValidationError('team_membersNotFound');
      }

      await Team_membersDBApi.update(id, data, {
        currentUser,
        transaction,
      });
  ...
  static async remove(id, currentUser) {
    ...
    try {
      ...
      await Team_membersDBApi.remove(id, {
        currentUser,
        transaction,
      });
