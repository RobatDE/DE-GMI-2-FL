...
const TableSampleProjects = ({ filterItems, setFilterItems, filters }) => {
  ...
  const handleViewAction = (id: string) => {
    router.push(`/projects/projects-view/?id=${id}`);
  };
...
export default TableSampleProjects;
