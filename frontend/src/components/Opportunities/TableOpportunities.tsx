...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/opportunities/opportunitiesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureOpportunitiesCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 5;

const TableSampleOpportunities = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (opportunitiesNotify.showNotification) {
      notify(
        opportunitiesNotify.typeNotification,
        opportunitiesNotify.textNotification,
      );
    }
  }, [opportunitiesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/opportunities/opportunities-view/?id=${id}`);
  };
...
export default TableSampleOpportunities;
