...
export const loadColumns = async (
  ...
  return [
...

    {
      ...
      headerName: 'Companynumber Of Employees',
      flex: 1,
      minWidth: 120,
      filterable: false,
      headerClassName: 'datagrid--header',
...

    {
      ...
      headerName: 'Companyannual Revenue',
      flex: 1,
      minWidth: 120,
      filterable: false,
      headerClassName: 'datagrid--header',
