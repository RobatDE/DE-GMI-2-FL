...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/prompts/promptsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configurePromptsCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 5;

const TableSamplePrompts = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (promptsNotify.showNotification) {
      notify(promptsNotify.typeNotification, promptsNotify.textNotification);
    }
  }, [promptsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/prompts/prompts-view/?id=${id}`);
  };
...
export default TableSamplePrompts;
