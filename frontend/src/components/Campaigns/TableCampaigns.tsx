...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/campaigns/campaignsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureCampaignsCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 5;

const TableSampleCampaigns = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (campaignsNotify.showNotification) {
      notify(
        campaignsNotify.typeNotification,
        campaignsNotify.textNotification,
      );
    }
  }, [campaignsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/campaigns/campaigns-view/?id=${id}`);
  };
...
export default TableSampleCampaigns;
