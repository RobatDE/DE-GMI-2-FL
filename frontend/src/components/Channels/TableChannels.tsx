...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/channels/channelsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureChannelsCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 5;

const TableSampleChannels = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (channelsNotify.showNotification) {
      notify(channelsNotify.typeNotification, channelsNotify.textNotification);
    }
  }, [channelsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/channels/channels-view/?id=${id}`);
  };
...
export default TableSampleChannels;
