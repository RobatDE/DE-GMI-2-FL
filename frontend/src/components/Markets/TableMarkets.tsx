...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/markets/marketsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureMarketsCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 5;

const TableSampleMarkets = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (marketsNotify.showNotification) {
      notify(marketsNotify.typeNotification, marketsNotify.textNotification);
    }
  }, [marketsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/markets/markets-view/?id=${id}`);
  };
...
export default TableSampleMarkets;
