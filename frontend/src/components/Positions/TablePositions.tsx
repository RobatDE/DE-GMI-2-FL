...
import { loadColumns } from './configurePositionsCols';
...
//    const query = `?page=${page}&limit=${perPage}${request}&sort=${sort}&field=${field}`;
  ...
  const handleViewAction = (id: string) => {
    router.push(`/positions/positions-view/?id=${id}`);
  };
  ...
  const handleTableSubmit = async (id: string, data) => {
    console.log('positions table submit id: ', id);
    console.log('positions data: ', JSON.stringify(data));
