...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/teams/teamsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTeamsCols';
import _ from 'lodash';
import dataFormatter from '../../helpers/dataFormatter';

const perPage = 5;

const TableSampleTeams = ({ filterItems, setFilterItems, filters }) => {
  ...
  useEffect(() => {
    if (teamsNotify.showNotification) {
      notify(teamsNotify.typeNotification, teamsNotify.textNotification);
    }
  }, [teamsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/teams/teams-view/?id=${id}`);
  };
...
export default TableSampleTeams;
